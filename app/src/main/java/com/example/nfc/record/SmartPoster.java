...
public class SmartPoster implements ParsedNdefRecord {
     ...
     * optional."
     */
    private final com.example.nfc.record.TextRecord mTitleRecord;
    ...
    private SmartPoster(UriRecord uri, com.example.nfc.record.TextRecord title, RecommendedAction action, String type) {
     ...
     */
    public com.example.nfc.record.TextRecord getTitle() {
        return mTitleRecord;
    }
    ...
    public static SmartPoster parse(NdefRecord[] recordsRaw) {
        try {
            ...
            com.example.nfc.record.TextRecord title = getFirstIfExists(records, com.example.nfc.record.TextRecord.class);
    ...
    public View getView(Activity activity, LayoutInflater inflater, ViewGroup parent, int offset) {
        if (mTitleRecord != null) {
            ...
            inflater.inflate(R.layout.activity_case, container);
