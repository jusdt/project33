...
public class FileUtils {
    ...
    public static void copy(AssetFileDescriptor fd, String destFile) {
        ...
        if (isFileExist(destFile)) {
            com.example.nfc.utils.LogUtils.logi("already exist, skiped:" + destFile);
            return;
        }
        ...
        if (fd != null) {
            try {
                ...
                e.printStackTrace();
                com.example.nfc.utils.LogUtils.loge("copy sound file failed");
            } finally {
                try {
                    if (in != null)
                        in.close();
            ...
            com.example.nfc.utils.LogUtils.loge("can't find the file");
        }
    }
